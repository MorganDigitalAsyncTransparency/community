...
**RM-4.** All resolved topics — both solved and self-closed — are included in the resolution time calculation, because both outcomes represent a topic leaving the open queue.
