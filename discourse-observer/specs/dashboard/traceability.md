...
| Use case | Spec | Requirements | Verification |
|----------|------|-------------|--------------|
| UC-8: Track response time trends | [response-time-trends.md](response-time-trends.md) | RT-1 – RT-10 | [response-time-trends.unit.test.ts](../../tests/dashboard/response-time-trends.unit.test.ts) (RT-1 – RT-8, RT-10); manual (RT-9, RT-11) |
