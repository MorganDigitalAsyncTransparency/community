...
Provides a realistic set of 19 topics covering all API endpoint scenarios: unreplied, resolved (solved and self-closed), replied-open, untagged, stalled, and multi-tag topics. Topics span a range of creation dates to exercise period filtering and time bucketing.
