...
import type { MedianBucket } from "../api/types";
...
function toChartPoints(buckets: MedianBucket[]): ChartPoint[] {
  return buckets.map((b) => ({
    label: b.label,
    bucketKey: b.bucketKey,
    medianHours: b.medianMs === null ? undefined : b.medianMs / MILLISECONDS_PER_HOUR,
  }));
}
