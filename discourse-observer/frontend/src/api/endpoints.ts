...
export const fetchTagFlows = (f: FilterParams) =>
  apiFetch<TagFlows>("/metrics/tag-flows", f);

export const fetchEscalations = (f: FilterParams) =>
  apiFetch<Escalations>("/metrics/escalations", f);
